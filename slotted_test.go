...
func TestSlottedPage_RoundTrip_Tombstone(t *testing.T) {
	kvs := []KV{
		...
		{Key: "dead", Vptr: VPtr{Length: rawVlenTombstone}, Hlc: 2}, // tombstone
...
func TestSlottedPage_Dump(t *testing.T) {
	kvs := []KV{
		...
		{Key: "charlie", Vptr: VPtr{Length: rawVlenTombstone}, Hlc: 1005}, // tombstone
	}
...
func TestSlottedPage_DumpWithVLog(t *testing.T) {
	...
	kvs := []KV{
		...
		{Key: "charlie", Vptr: VPtr{Length: rawVlenTombstone}, Hlc: 175}, // tombstone
