...
func TestWormholeRandomizedSetGetDeleteCorrectness(t *testing.T) {
...
func assertWormholeAll(t *testing.T, m *wormhole, model map[string]KV, seed uint64, run, step int) {
	t.Helper()
